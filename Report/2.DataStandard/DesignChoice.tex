...
The\textit{Data Preprocessing} is supposed to be done once where the result are a text file representing each path in the training data. The data is created to 
